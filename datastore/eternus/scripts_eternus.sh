...
while IFS= read -r -d '' element; do
    XPATH_ELEMENTS[i++]="$element"
                    ...
                    /DS_DRIVER_ACTION_DATA/DATASTORE/DEBUG \
...
DEBUG="${XPATH_ELEMENTS[5]:-N}"
ARRAY_MGMTIP="${XPATH_ELEMENTS[6]}"
ARRAY_POOL_NAME="${XPATH_ELEMENTS[7]}"
FSTYPE="${XPATH_ELEMENTS[8]}"
SIZE="${XPATH_ELEMENTS[9]:-0}"

export BASE_PATH RESTRICTED_DIRS SAFE_DIRS UMASK BRIDGE_LIST FSTYPE SIZE
export DEBUG
